...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Saturnina Concept Hair. Uma experiência autoral de beleza, identidade e presença." },
      { name: "author", content: "Saturnina" },
      { property: "og:title", content: "Saturnina — Beleza que revela presença" },
      { property: "og:description", content: "Uma experiência autoral de beleza, identidade e presença." },
