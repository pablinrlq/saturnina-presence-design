    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <Button
            asChild
            variant={overlay ? "lightOutline" : "outline"}
        ...
        <nav className="mx-auto grid min-h-[75vh] max-w-6xl content-center gap-3 px-6 md:grid-cols-2 md:gap-x-20">
          {links.map(([label, to], index) => (
            <Link
              ...
              to={to}
              onClick={() => setOpen(false)}
              className="group flex items-center gap-5 border-b border-primary-foreground/20 py-4 font-display text-4xl md:text-6xl"
            >
